...
<MetaTags
    ...
    twitter={{
        ...
        image: `${SITE_ORIGIN}/images/tv/logo-antina-meta.png`,
...
<section>
    ...
    <TvAvailability stores={['googleplay', 'roku']} warnMagisXuper={true} />
